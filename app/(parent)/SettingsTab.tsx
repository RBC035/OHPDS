    ...
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
      ...
      <View style={[styles.profileHeader, { paddingTop: insets.top + 24 }]}>
        ...
        <View style={styles.profileTag}>
          <Ionicons name="people-circle-outline" size={11} color="#fff" />
          <Text style={styles.profileTagText}> {parentId(user?.id)}</Text>
        </View>
      </View>
      ...
      <View style={styles.body}>
        ...
        <View style={styles.section}>
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.rowSub}>Name, phone</Text>
            </View>
        ...
        <View style={styles.section}>
          <View style={styles.row}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.rowLabel}>Parent ID</Text>
              <Text style={styles.rowSub}>{parentId(user?.id)}</Text>
            </View>
          </View>
          ...
          <View style={styles.row}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.rowLabel}>Email (username)</Text>
