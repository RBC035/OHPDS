...
export default function SubjectHomework() {
  const { subjectId, classId, studentId, subjectName, className, studyYear } =
  ...
  const overdue = homework.filter(
    (hw) => isDue(hw.endDate) && hw.status !== "completed",
  ).length;
      ...
      {loading ? (
        ...
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptySub}>
            No homework has been assigned for this subject yet
          </Text>
        </View>
      ) : (
        <ScrollView
                    ...
                    <View style={styles.hwRight}>
                      ...
                      >
                        ...
                        <Text style={[styles.statusText, { color }]}>
                          {overdueBool
                            ? "Overdue"
                            : hw.status.charAt(0).toUpperCase() +
                              hw.status.slice(1)}
                        </Text>
                      </View>
                      <Ionicons
                    ...
                    <View style={styles.dateCol}>
                      <View style={styles.dateLabelRow}>
                        <Ionicons
                          ...
                          color="#2563EB"
                        />
                        <Text style={[styles.dateLabel, { color: "#2563EB" }]}>
                          Start
                        </Text>
                      </View>
                      <Text style={styles.dateVal}>
                        {formatDate(hw.startDate)}
                      </Text>
                    </View>
