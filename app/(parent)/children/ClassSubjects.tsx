  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.header}>
        ...
        <View style={{ flex: 1 }}>
          <Text style={styles.headerTitle} numberOfLines={1}>{className ?? "Class"}</Text>
      ...
      <View style={styles.statsStrip}>
        ...
        <View style={styles.statItem}>
          <Text style={styles.statNum}>
            {loading
              ? "—"
              : subjects.filter(s => (s.status ?? "active").toLowerCase() === "active").length || subjects.length}
          </Text>
      ...
      {loading ? (
        ...
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptySub}>No subjects are assigned to this class yet</Text>
        </View>
      ) : (
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          ...
          {subjects.map((sub, index) => {
            ...
            const isActive = (sub.status ?? "active").toLowerCase() === "active";
            ...
            return (
              ...
              >
                <View style={[styles.subjectIcon, { backgroundColor: palette.iconBg, borderColor: palette.borderColor }]}>
...
const styles = StyleSheet.create({
  ...
  subjectMetaRow: { flexDirection: "row", alignItems: "center", gap: 4, marginTop: 3 },
  ...
  emptySub:   { fontSize: 12, color: Colors.textSecondary, textAlign: "center", paddingHorizontal: 40 },
});
