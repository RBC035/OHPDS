...
function subjectColor(subject: string) {
  ...
  return FALLBACK_SUBJECT_PALETTE[
    Math.abs(hash) % FALLBACK_SUBJECT_PALETTE.length
  ];
}
    ...
    <SafeAreaView style={styles.container} edges={["left", "right", "bottom"]}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 14 }]}>
        ...
        <View style={styles.statsStrip}>
          ...
          <View style={styles.stripItem}>
            <Text style={[styles.stripNum, { color: "#FED7AA" }]}>
              {pendingCount}
            </Text>
          ...
          <View style={styles.stripDivider} />
          <View style={styles.stripItem}>
            <Text style={[styles.stripNum, { color: "#BBF7D0" }]}>
              {submittedCount}
            </Text>
          ...
          <View style={styles.stripDivider} />
          <View style={styles.stripItem}>
            <Text style={[styles.stripNum, { color: "#FECACA" }]}>
              {overdueCount}
            </Text>
        ...
        {TABS.map((t) => {
          ...
          return (
            ...
            >
              ...
              >
                <Text
                  style={[styles.chipCountText, active && { color: "#fff" }]}
                >
                  {tabCount(t)}
                </Text>
              </View>
          ...
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySub}>
              {filterStatus === "All"
                ...
                : `No ${filterStatus.toLowerCase()} homework`}
            </Text>
          </View>
        ) : (
          filtered.map((h) => {
                ...
                <View style={styles.cardBody}>
                  ...
                  <View style={styles.cardTopRow}>
                    ...
                    <View
                      style={[
                        styles.statusPill,
                        { backgroundColor: sm.bg, borderColor: sm.border },
                      ]}
                    >
                  ...
                  <View style={styles.cardBottom}>
                    ...
                    <View
                      style={[
                        ...
                        {
                          backgroundColor:
                            h.submissionCount > 0 ? "#DCFCE7" : "#F3F4F6",
                        },
                      ]}
                    >
                      <Ionicons
                      ...
                      <Text
                        style={[
                          ...
                          {
                            color:
                              h.submissionCount > 0 ? "#16A34A" : "#9CA3AF",
                          },
                        ]}
                      >
                        {" "}
                        {h.submissionCount} submission
